...
from keras.layers.convolutional import Convolution3D, MaxPooling3D, UpSampling3D, Convolution2D
...
class Encoder3D:
    ...
    def __init__(self, cfg):
        ...
        self.conv3d_layers = [self.create_3d_conv_layer(n_conv) for n_conv in range(int(self.args['n_convs3d']))]
        ...
        self.conv2d_layers = [self.create_2d_conv_layer(n_conv) for n_conv in range(int(self.args['n_convs2d']))]
